...
class UploadImageAdapter(
        ...
        data: List<FileInfo>?,
        var itemlayout: Int,
var editable:Boolean) : BaseQuickAdapter<FileInfo, BaseViewHolder>(itemlayout, data) {

    var addImageRes: Int? = R.drawable.add_image
    var itemWidth: Int? = -1
...
//        }
        if (editable&&helper.position == mData.size - 1) {
...
//            cover.setImageResource(R.drawable.add)
            ...
            if(editable)helper.setVisible(R.id.iv_cancel, true)
