        ...
        when (v?.id) {
            ...
            R.id.bt_file_system -> {
                ...
                rxPermission
                    ...
                    .subscribe { t ->
                        if (t?.granted!!) {
                            ARouter.getInstance().build("/module/file/main")
                                .navigation()
...
//                startActivity(Intent(this, TensorFlowActivity::class.java))
                ARouter.getInstance().build("/module/tensorflow/main")
                    .navigation()
            }
            R.id.bt_camera2->{
...
//                startActivity(Intent(this,VRVideoActivity::class.java))
                ARouter.getInstance().build("/module/vr/main")
                    .navigation()
            }
            R.id.bt_ar_solar->{
//                startActivity(Intent(this, SolarActivity::class.java))
                ARouter.getInstance().build("/module/ar/solar")
                    .navigation()
            }
            R.id.bt_bluetooth -> {
...
//                startActivity(Intent(this, FingerPrintBaseActivity::class.java))
                ARouter.getInstance().build("/module/finger/main")
//                    .withInt("fragment", R.string.bluetooth)
                    .navigation()
            }
